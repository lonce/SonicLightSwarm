...
require(
	["master", "comm", "utils", "touch2Mouse",  "soundbank", "agentPlayer", "config", "lightswarmConfig"],

	function (master, comm, utils, touch2Mouse,  soundbank, agentPlayer, config, lightswarmConfig) {

		var mouse_down=false;
		var m_agent;

		if (!master()) history.go(-1);
